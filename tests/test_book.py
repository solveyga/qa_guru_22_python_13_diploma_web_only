...
@allure.story('Проверка обязательной регистрации для чтения бесплатной книги неавторизованным пользователем')
...
@allure.story('Проверка чтения фрагмента для книги из стандартной подписки неавторизованным пользователем')
...
@allure.story('Проверка чтения фрагмента для книги из премиум подписки неавторизованным пользователем')
...
@allure.step('Проверить чтение ознакомительного фрагмента неавторизованным пользователем')
